...
public class User {
    ...
    public User(String FullName, String Username, String Email, String ContactNo, String DOB, String Password, UserType UserType) {
    ...
    public User(String FullName, String Username, String Email, String ContactNo, String DOB, UserType UserType, String UID) {
        this.FullName = FullName;
        this.Username = Username;
        this.Email = Email;
        this.ContactNo = ContactNo;
    ...
    public boolean Validate(){
        ...
        try {
            File f = new File(FilePath.getPath(FilePath.USER_DETAILS));
    ...
    public boolean Register(){
        ...
        Path RegistrationTargetPath = Paths.get(FilePath.getPath(FilePath.USER_DETAILS));
        
        for(String str:temp) RegistrationStr += str + ";";

        try{
            BufferedWriter bw = new BufferedWriter(new FileWriter(FilePath.getPath(FilePath.USER_DETAILS), true));
    ...
    private static int getFileRows(){
        int row = 0;
        try {
            BufferedReader rd = new BufferedReader(new FileReader(FilePath.getPath(FilePath.USER_DETAILS)));
