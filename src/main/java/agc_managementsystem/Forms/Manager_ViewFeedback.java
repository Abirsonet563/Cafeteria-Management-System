...
import com.mycompany.agc_managementsystem.Feedback_Manager;
...
public class Manager_ViewFeedback extends javax.swing.JFrame {
    private User user = null;
    /**
     * Creates new form Manager_ViewFeedback
     */
    public Manager_ViewFeedback() {
        initComponents();
        
        // Refresh the table every time this form is opened
        DefaultTableModel tb = (DefaultTableModel) tableFeedback.getModel();
        Feedback_Manager fm = new Feedback_Manager();
        ArrayList<String> feedbacks = fm.getLatestFeedbacks();
        String [] data= null;
        for(String dataLine:feedbacks)
        {
            data = dataLine.split(";");
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        try {
            ...
            FileOutputStream fos = new FileOutputStream(new File(FilePath.getPath(FilePath.FEEDBACK)));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Manager_ViewFeedback.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Manager_ViewFeedback().setVisible(true);
            }
        });
    }
