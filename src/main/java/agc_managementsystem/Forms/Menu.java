...
public class Menu extends javax.swing.JFrame {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(idtxt, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 204, Short.MAX_VALUE)
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        ...
        File file = new File (FilePath.getPath(FilePath.MENU));
      //  String TRcist_nameAINER_ID = textTI.getText().trim();
        String FoodID = idtxt.getText().trim();
        String FoodName = nametxt.getText().trim();
        // String Gender = cmbGender.getText().trim();
        //String FoodPrice = pricetxt.getText().trim();
        
        
            try(PrintWriter writer = new PrintWriter(new BufferedWriter(new FileWriter((FilePath.getPath(FilePath.MENU)),true))))
        {
            // writer.append(TRAINER_ID+",");
            writer.append(FoodID+";");
            writer.append(FoodName+";");
            //writer.append(FoodPrice+",");
           // writer.append(Date_of_Birth+",");
            writer.print("\n");
            writer.close();
